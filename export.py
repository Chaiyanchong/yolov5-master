...
def run(data=ROOT / 'data/coco128.yaml',  # 'dataset.yaml path'
        weights='/home/bc/yolov5-master/runs/train/exp78/weights/best.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='E:/DLPROJTCT/yolov5-master/data/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default='E:/DLPROJTCT/yolov5-master/runs/train/exp7/weights/best.pt', help='weights path')
